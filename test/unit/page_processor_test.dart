...
void main() {
  ...
  group('PageProcessor', () {
    ...
    test('render rotates 90° clockwise before cropping', () async {
      ...
      for (var y = 0; y < 100; y++) {
        for (var x = 0; x < 200; x++) {
          if (x < 100) {
            ...
            image.setPixelRgb(x, y, 20, 20, 220);
          }
        }
      }
      ...
      // Left half (red) becomes the top half after a clockwise turn.
      final top = decoded.getPixel(50, 25);
      final bottom = decoded.getPixel(50, 175);
