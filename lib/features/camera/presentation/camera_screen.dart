              ...
              return AnimatedContainer(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      switch (state.phase) {
                        ScanPhase.searching => Icons.search_rounded,
                        ScanPhase.positioning => Icons.crop_free_rounded,
                        ScanPhase.tooFar => Icons.zoom_in_rounded,
                        ScanPhase.holdSteady =>
                          Icons.center_focus_strong_rounded,
                        ScanPhase.capturing => Icons.camera_rounded,
                        ScanPhase.captured => Icons.check_circle_rounded,
                      },
                      size: 18,
                      color: _overlayColor(state),
                    ),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: CircularProgressIndicator(
                ...
                valueColor: const AlwaysStoppedAnimation(Brand.accentLight),
              ),
            ),
            AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                'Run Scanella on iOS or Android to scan documents.',
                textAlign: TextAlign.center,
              ),
